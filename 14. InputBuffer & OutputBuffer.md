...
## `Http11InputBuffer`
用到了两个`ByteBuffer`：`Http11InputBuffer#ByteBuffer byteBuffer`、`SocketWrapperBase#SocketBufferHandler socketBufferHandler#ByteBuffer readBuffer`</br>

以Nio为例，向`Http11InputBuffer#ByteBuffer byteBuffer`中写数据的调用栈
```
